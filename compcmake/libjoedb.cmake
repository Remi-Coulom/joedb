...
target_link_libraries(joedb joedb_bootstrap)
target_link_libraries(joedb Threads::Threads)

if(libssh_FOUND)
 target_link_libraries(joedb_bootstrap ${LIBSSH_LIBRARIES})
endif()

if(CURL_FOUND)
 target_link_libraries(joedb_bootstrap ${CURL_LIBRARIES})
endif()

if(brotli_encode_path)
 if (MSVC)
  target_link_libraries(joedb_bootstrap unofficial::brotli::brotlidec)
  target_link_libraries(joedb_bootstrap unofficial::brotli::brotlienc)
 else()
  target_link_libraries(joedb_bootstrap brotlienc brotlidec)
 endif()
endif()
