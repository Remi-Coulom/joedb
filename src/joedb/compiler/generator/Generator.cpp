...
namespace joedb::generator
{
 ...
 ////////////////////////////////////////////////////////////////////////////
 bool Generator::table_has_field_type(Table_Id table_id, Type::Type_Id type_id) const
 ////////////////////////////////////////////////////////////////////////////
 {
  for (const auto &[fid, fname]: options.db.get_fields(table_id))
   if (options.db.get_field_type(table_id, fid).get_type_id() == type_id)
    return true;
  return false;
 }
