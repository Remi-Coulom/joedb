...
namespace joedb
{
 ...
 )
 {
  ...
  log(std::string("hash result: ") + buffer.data[0]);
 ...
 )
 {
  ...
  log("pulling, lock = " + std::to_string(int(lock_action)) +
 ...
 ////////////////////////////////////////////////////////////////////////////
 {
  log("joedb::Server_Connection::unlock");
