...
namespace joedb
{
 ...
 ////////////////////////////////////////////////////////////////////////////
 streambuf::pos_type streambuf::seekpos
 ////////////////////////////////////////////////////////////////////////////
 (
  pos_type pos,
  std::ios_base::openmode which
 ...
 ////////////////////////////////////////////////////////////////////////////
 std::streamsize streambuf::xsgetn(char_type* s, std::streamsize count)
 ////////////////////////////////////////////////////////////////////////////
 {
 ...
 ////////////////////////////////////////////////////////////////////////////
 std::streamsize streambuf::xsputn(const char_type* s, std::streamsize count)
 ////////////////////////////////////////////////////////////////////////////
 {
 ...
 ////////////////////////////////////////////////////////////////////////////
 streambuf::streambuf(Abstract_File &file): file(file)
 ////////////////////////////////////////////////////////////////////////////
 {
  in_pos = 0;
  setg(buffer.data(), buffer.data(), buffer.data());
