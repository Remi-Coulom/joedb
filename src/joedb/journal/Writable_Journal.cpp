...
/////////////////////////////////////////////////////////////////////////////
joedb::Writable_Journal::Tail_Writer::Tail_Writer(Writable_Journal &journal):
/////////////////////////////////////////////////////////////////////////////
 old_position(journal.file.get_position()),
 journal(journal)
{
 journal.file.set_position(journal.checkpoint_position);
}

/////////////////////////////////////////////////////////////////////////////
void joedb::Writable_Journal::Tail_Writer::append
/////////////////////////////////////////////////////////////////////////////
(
 const char *buffer,
 size_t size
...
{
 journal.file.append_tail(buffer, size);
}
...
/////////////////////////////////////////////////////////////////////////////
{
 ...
 tail_writer.append(data.data(), data.size());
}
