...
/////////////////////////////////////////////////////////////////////////////
void joedb::Writable_Journal::end_writing(int64_t position)
/////////////////////////////////////////////////////////////////////////////
{
 if (position != file.get_position())
...
/////////////////////////////////////////////////////////////////////////////
void joedb::Writable_Journal::soft_checkpoint()
/////////////////////////////////////////////////////////////////////////////
{
 soft_checkpoint_at(file.get_position());
}

/////////////////////////////////////////////////////////////////////////////
void joedb::Writable_Journal::hard_checkpoint()
/////////////////////////////////////////////////////////////////////////////
{
 hard_checkpoint_at(file.get_position());
}
