...
media. For each blob, only the size and position of the data in the joedb file
is loaded into memory.  The content of a blob can be loaded on demand with the
