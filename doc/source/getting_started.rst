...
.. code-block:: bash
    ...
    sudo apt-get install g++ cmake ninja-build lcov unzip valgrind python-sphinx python-sphinx-rtd-theme python-sphinxcontrib.spelling wget git-core sqlite3 libsqlite3-dev sqlitebrowser
